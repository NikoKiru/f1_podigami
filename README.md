...
[![Tests](https://img.shields.io/badge/tests-751%20passing-brightgreen?style=flat-square&logo=pytest&logoColor=white)](tests/)
...
tests/          pytest suite (755 tests, run in CI)
```
...
pytest --cov                          # 755 tests + coverage gate (≥70%)
```
