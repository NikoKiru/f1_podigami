...
[![Tests](https://img.shields.io/badge/tests-597%20passing-brightgreen?style=flat-square&logo=pytest&logoColor=white)](tests/)
...
tests/          pytest suite (597 tests, run in CI)
```
...
pytest --cov                          # 597 tests + coverage gate (≥70%)
```
