...
[![Tests](https://img.shields.io/badge/tests-686%20passing-brightgreen?style=flat-square&logo=pytest&logoColor=white)](tests/)
...
tests/          pytest suite (686 tests, run in CI)
```
...
pytest --cov                          # 686 tests + coverage gate (≥70%)
```
