...
[![Tests](https://img.shields.io/badge/tests-626%20passing-brightgreen?style=flat-square&logo=pytest&logoColor=white)](tests/)
...
tests/          pytest suite (626 tests, run in CI)
```
...
pytest --cov                          # 626 tests + coverage gate (≥70%)
```
