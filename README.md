...
[![Tests](https://img.shields.io/badge/tests-647%20passing-brightgreen?style=flat-square&logo=pytest&logoColor=white)](tests/)
...
tests/          pytest suite (647 tests, run in CI)
```
