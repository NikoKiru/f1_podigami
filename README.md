...
[![Tests](https://img.shields.io/badge/tests-728%20passing-brightgreen?style=flat-square&logo=pytest&logoColor=white)](tests/)
...
tests/          pytest suite (728 tests, run in CI)
```
