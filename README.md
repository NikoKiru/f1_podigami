...
[![Tests](https://img.shields.io/badge/tests-605%20passing-brightgreen?style=flat-square&logo=pytest&logoColor=white)](tests/)
...
tests/          pytest suite (605 tests, run in CI)
```
...
pytest --cov                          # 605 tests + coverage gate (≥70%)
```
